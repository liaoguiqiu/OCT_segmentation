...
class A_line_syn():
    ...
    def generator_Aline(self,H,bound_pos): # input bound psition should be a array and the max position of the array should be = H
        u0 = -1/100 # this is the basic attenuation coeff
        uii = -1/900
    ...
    def random_image(self,H,W):
        ...
        for i in range(W):
            ...
            source_line = self.generator_Aline(H,[300,600,900])  
...
if __name__ == '__main__':
    ...
    bound_pos=np.array([400,600,650])
    y  = generator.generator_Aline(1024, bound_pos)
    generator.plot_1d(y)
